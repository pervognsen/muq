...
( - 475-W-oldmsh-doing.muf -- Do player '@doing'.			)
...
( defmethod:  cmdHelpCategory { 'cmdDoing }	)
(    {[                         'it      ]}	)
(    [ "" |                              	)
( ;                                      	)
...
defmethod:  cmdHelp1 { 'cmdDoing }
    {[                 'it      ]}

    [ "Set your \"doing\" field (displayed by @who command)." |
;
...
defmethod:  cmdHelpN { 'cmdDoing }
    {[                 'it      ]}

    [
"Set the text displayed as your \"doing\" value by the @who command."
    |
;
