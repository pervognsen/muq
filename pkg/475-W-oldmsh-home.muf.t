...
( - 475-W-oldmsh-home.muf -- Command for mudUser shell package.	)
...
( defmethod:  cmdHelpCategory { 'cmdHome }	)
(    {[                         'it     ]}	)
(    [ "" |                              	)
( ;                                      	)
...
defmethod:  cmdHelp1 { 'cmdHome }
    {[                   'it      ]}

    [ "Go home from wherever we are." |
;
...
defmethod:  cmdHelpN { 'cmdHome }
    {[                   'it      ]}

    [
"Takes you back to your home room.  You can -always- go home."
    |
;
