...
( - 475-W-oldmsh-undig.muf -- Command for mudUser shell package.	)
...
( defmethod:  cmdHelpCategory { 'cmdUndig }	)
(    {[                         'it      ]}	)
(    [ "" |                              	)
( ;                                      	)
...
defmethod:  cmdHelpN { 'cmdUndig }
    {[                 'it      ]}

    [
"Uncreate an existing room: @undig <roomName>."
    |
;
